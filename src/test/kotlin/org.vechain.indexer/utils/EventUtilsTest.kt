...
internal class EventUtilsTest {
    ...
    inner class DecodeEvent {
        ...
        fun `should decode string array correctly `() {
            ...
            expectThat(result).isEqualTo(
                GenericEventParameters(
                    returnValues = mapOf("name" to listOf("Apple", "Mango", "Banana", "Orange", "Grapes")),
                    eventType = "Names",
                ),
            )
        }
            ...
            expectThat(result).isEqualTo(
                GenericEventParameters(
                    returnValues =
                        mapOf(
                            "addresses" to
                                listOf("0xf8e81D47203A594245E36C48e151709F0C19fBe8", "0xd9145CCE52D386f254917e481eB44e9943F39138"),
                        ),
                    eventType = "Addresses",
                ),
            )
                        ...
                        mapOf(
                            "person" to
                                mapOf(
                                    ...
                                    "fruit" to listOf("Apple", "Mango", "Banana", "Orange", "Grapes"),
                                    "wallets" to
                                        listOf(
